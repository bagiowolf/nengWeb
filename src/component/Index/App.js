        ...
        <div className="HeadDiv">
          ...
          >
            <div className="left" style={{ width: 720 * scal + 'px' }}>
              ...
              >
                <div
                  style={{ marginBottom: 30 * scal + 'px', textIndent: '2em' }}
                >
                  江苏竭能法律咨询服务有限公司（以下简称“竭律法务”）成立于2013年，坐落在风景秀美、人文底蕴深厚的江南历史文化名城——常州，也是新中国第一任司法部女部长史良的故乡。
                </div>
                <div
                  style={{ marginBottom: 30 * scal + 'px', textIndent: '2em' }}
                >
                  竭律法务自成立以来，始终秉持通过我们精准的服务和精通的专业知识来实现长期繁荣发展。我们致力于运用自身的从业经验、专项业务能力和事件的洞察力，帮助客户应对不断变化的客观环境，提振信心、谋求稳定发展。
                </div>
                <div
                  style={{ marginBottom: 30 * scal + 'px', textIndent: '2em' }}
                >
                  竭律法务以建设复合型、专业化的人才队伍为导向，团队成员拥有国内外知名院校法学专业教育背景以及丰富的法律职业经历，助力客户应对日益复杂的商业挑战，为客户提供“一站无忧”的问题解决方案。
                </div>
                <div
                  style={{ marginBottom: 30 * scal + 'px', textIndent: '2em' }}
                >
                  客户是我们开展一切工作的核心。竭律法务将继续秉持“专业、专心、专注”的服务理念继续坚持提升业务能力，不断寻求突破，从根本上理解客户的需求，帮助客户解决问题和发掘机遇。
                </div>
          ...
          <div
            ...
            className="xinwen"
            style={{
              padding: `${50 * scal}px ${300 * scal}px`,
          ...
          >
            ...
            <div className="imgBox123">
              <div
                className="left"
                style={{ width: 630 * scal + 'px', height: 521 * scal + 'px' }}
              ...
              >
                ...
                >
                  <div
                    className="title"
                    style={{ fontSize: 20 * scal + 'px', fontWeight: 400 }}
                    title={first?.title}
                  >
                    {first?.title}
                  </div>
