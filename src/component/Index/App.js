    ...
    <div className="HeadDiv">
            ...
            <div className="box1">
              ...
              <div className="lunboText" style={{ fontSize: 30 * scal + 'px' }}>
                <img
                  src={png2}
                  alt=""
                  style={{ width: 288 * scal + 'px', height: 30 * scal + 'px' }}
                />
      ...
      >
        ...
        <div style={{ width: 510 * scal + 'px' }}>
          ...
          >
            <NumberAnimation targetValue={yi} isSplit={false}></NumberAnimation>
          ...
          >
            ...
            >
              <img
                src={icon5}
                alt=""
                style={{ width: 66 * scal + 'px', height: 82 * scal + 'px' }}
              />
              <div
                style={{
                  fontSize: 24 * scal + 'px',
        ...
        >
          ...
          >
            <img
              src={team1}
              alt=""
              style={{ width: 320 * scal + 'px', height: 330 * scal + 'px' }}
            />
            <img
              src={team2}
              alt=""
          ...
          <div className="center" style={{ width: 610 * scal + 'px' }}>
            <img src={team4} alt="" style={{ width: '100%', height: '100%' }} />
          </div>
          <div
            className="right"
            style={{
      ...
      >
        ...
        <div style={{ display: 'flex' }}>
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src={ys1}
                    style={{ width: 35 * scal + 'px', position: 'relative' }}
                    alt=""
                  />
                </div>
                <div
          ...
          <div
            style={{ position: 'relative', left: (1238 - 565) * scal + 'px' }}
          >
            <div
              style={{
                width: 565 * scal + 'px',
      ...
      >
        ...
        >
          <img
            src={yj}
            alt=""
            style={{ width: 127 * scal + 'px', marginRight: 64 * scal + 'px' }}
          />
